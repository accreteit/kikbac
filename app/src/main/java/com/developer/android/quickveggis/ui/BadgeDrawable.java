package com.developer.android.quickveggis.ui;
...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), android.support.design.R.color.material_blue_grey_800));
